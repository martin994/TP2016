...
public class Mapa {
	...
	private static int menorDistancia=99;
	private static LinkedList<LinkedList<Peaje>> caminosCortos;
	public static void main(String[] args){
		...
		Avenida av3 = new Avenida("", 30, 6, p1, p4, true);
		Avenida av4 = new Avenida("", 30, 4, p2, p5, true);
		Avenida av5 = new Avenida("", 30, 3, p2, p6, true);
		Avenida av6 = new Avenida("", 30, 2, p3, p2, true);
		Avenida av7 = new Avenida("", 30, 7, p3, p5, true);
		Avenida av8 = new Avenida("", 30, 4, p4, p6, true);
		Avenida av9 = new Avenida("", 30, 3, p5, p7, true);
		Avenida av10 = new Avenida("", 30, 1, p6, p7, true);
	...
	private void caminosCortosKmBT(LinkedList<Peaje> tramo,Peaje fin, int kilometros){
		if((tramo.peekLast() ==null) || (tramo.peekLast().equals(fin))){
			...
			if( kilometros<menorDistancia){
				caminosCortos.clear();
				caminosCortos.add((LinkedList<Peaje>) tramo.clone());
				menorDistancia=kilometros;
			}else if(kilometros==menorDistancia){
				caminosCortos.add((LinkedList<Peaje>) tramo.clone());
			}
		}else{
			...
			for(Avenida avenidaAlterantiva: candidatos){
				...
				caminosCortosKmBT(tramo, fin, avenidaAlterantiva.getDistancia()+kilometros);
				tramo.removeLast();
			}
		}
	}
	...
	private ArrayList<Avenida> getCandidatos(Peaje inicio){
		...
		for(Avenida ruta:listaAvenidas){
